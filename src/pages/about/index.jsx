  ...
  return (
    ...
    <div className="main-wrapper" id="creator-container">
      <div className="OBA">
        ...
        <img src="/logo.svg" alt="Logo" className="OBALogo" />
      </div>
      <div className="Ateneo">
        <div className="Ateneo-text">
          ...
          <div className="Ateneo-body-pic">
            ...
            <img src="/about_ateneo.svg" alt="Ateneo" className="AteneoPic" />
          </div>
        </div>
      </div>
      <div className="Team">
        ...
        <div className="Team-cards">
          <div className="Team-three">
            <div className="Team-card">
              <img src='/profile.svg' alt='ProfilePic' className='profile-pic' />
